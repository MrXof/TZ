...
func calculateWidth(for view: UIView, at height: CGFloat) -> CGFloat {
  let size = view.systemLayoutSizeFitting(.init(width: .zero, height: height), withHorizontalFittingPriority: .fittingSizeLevel, verticalFittingPriority: .required)
